...
\chapter{Precharge}
The precharge is a circuit responsible for charging the large capacitance of the inverter through a large precharge resistor in order to avoid a large current spike when the main \acp{air} close.
...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|}
    ...
    \hline
    Low voltage input & \SI{12}{\volt} \\
    \hline
    High voltage input range & \SI{0}{\volt} -- \SI{500}{\volt} \\
    \hline
    Precharge resistance & \SI{1}{\kilo\ohm} \\
    \hline
    Precharge time to 95\% @ \SI{300}{\volt} \& \SI{200}{\micro\farad} & \SI{600}{\milli\second} \\
    \hline
  \end{tabular}
